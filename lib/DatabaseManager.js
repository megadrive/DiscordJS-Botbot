...
module.exports = class DatabaseManager {
   ...
   * @param {string[]} load List of collections to load
   */
  constructor(options = {
    ...
    this.log(`dataDir: ${options.dataDir}`)
  ...
  /**
   * Opens a collection.
   * @param string Name of collection to open.
  ...
  open(name) {
    ...
    const datastore = Datastore.create({
      filename: join(this.options.dataDir, name + ".json")
    });
   ...
   * @param string Name of collection to get.
   * @returns Datastore
   */
  get(name) {
   ...
   * @param string Name of collection to check.
   * @returns boolean
   */
  has(name) {
